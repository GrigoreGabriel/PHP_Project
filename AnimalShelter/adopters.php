...
<body>
    ...
    <br>
    <h5 class="center">Adopters List</h5>
    <div>
        <div class="container">
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">isOfLegalAge</th>
                        <th scope="col">isTaxPaid</th>
                        <th scope="col">canAdopt</th>
    ...
    if($result){
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $phoneNo = $row['phoneNo'];
            $isOfLegalAge = $row['isOfLegalAge'];
            $isTaxPaid = $row['isTaxPaid'];
            $canAdopt = $row['canAdopt'];
